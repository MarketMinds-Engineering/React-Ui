...
const Hero = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Provide You With A Awesome AI Driven 
      </h1>
      
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-blue-500">Trading
      </h1>
      ...
      <div class="flex justify-center">
       ...
       <Link href={"/about"}>
        <button class="ml-4 inline-flex text-black bg-gray-100 border-2 border-black py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">How It Works</button>
        </Link>
      </div>
    </div>
